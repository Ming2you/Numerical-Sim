...
# ★★WU 열(문헌 입자도 기준선) 완주 — 본표 완성 (2026-07-13)

본표 재편(사용자): NC/WU/P-Stack/P-CENT — nbr은 ablation 강등. WU = bare
WU-FAITHFUL-FOLLOWER(link agent, SEG13 미적용), 스텝당 2.7~4.9s.

| 무대 | WU | 계층(최종) | Δ | | 스위트 | WU | 계층 | Δ |
|---|---|---|---|---|---|---|---|---|
| 155 | 8317 | 7036 | −1281 | | mid136 | 701 | 691 | −10 |
| 155_skew | 8660 | 7509 | −1151 | | high169 | 1224 | 1236 | +12 |
| 155_inc | 8328 | 8124 | −204 | | high2 205 | 1971 | 1909 | −62 |
| 170 | 11561 | 11324 | −237 | | (high_skew/high_inc 측정 중) |
| 170_inc | 11520 | 11497 | −23 | | pulse_low(제외) WU 379 |
| 170_skew | 11907 | 11494 | −413 |
| 190 | 16219 | 15654 | −565 |

- WU 강기준선 확인: link agent가 링크 내 결합 내부화 → 190 무붕괴(16219, nbr
  22402와 대조). 그럼에도 **지속 7무대 계층 전승**(−23~−1281, 155계열 최대).
- **본표에서 hinge 적신호 소멸**: 155_inc 계층 8124 < WU 8328 (nbr 역전패는
  ablation 표 한정).
- 정직: 펄스 스위트는 WU와 동급(205%도 −62) — 극적 붕괴 대비는 r=1 nbr 전용
  (ablation 서사). 계산 사다리: WU 3s → 계층 60s → SLSQP 475s.
- 스위트 확정(사용자): 중136 / 고169 / 고+skew / 고+incident / 극한205 (low 제외).

# ★hinge 트레이드오프 완전 귀속 — 기본값 결정 대기 (2026-07-13)

최종 스윕 12셀 중 155_incident +943 적신호 → 귀속 완결(8-seg, T=7200).

| 무대 | 둘 다 OFF | NP-CAND만 | +hinge | hinge 순기여 |
|---|---|---|---|---|
| 155 | 7309 | 7268 | **7036** | −232 득 |
| 155_inc | 7181 | **7180** | 8124 | **+943 실 (nbr 7256에 역전패)** |
| 170 | 11593 | 11475 | **11324** | −151 득 |
| 190 | 15652 | **15535** | 15654 | +119 |
| 155_skew | 7509 | 7490 | 7509 | ~0 |
| 펄스 5무대 | — | — | 구판 동일 | ~0 |

- 기제: 사고의 임계 초과는 회피 불가능한 외생 혼잡인데 hinge가 전 후보에 과금 →
  leader가 지킬 수 없는 본선을 지키려 방류 조임(완주 −3,000). **v2(폐쇄 seg 면제)
  비트동일 무효** — 왜곡 원천은 폐쇄 상류 전파 큐의 후보 의존 과금(구조적).
- NP-CAND-λ̂는 전 무대 무해~유익 확정(155_inc 7180 = 구판 비트 동일).
- NP-CAND 열 완성: 170_skew 11505 / 170_inc 11514 (hinge 기여 −11/−17 ≈ 0).
  **170_inc 중립 vs 155_inc +943 유해의 비대칭** — hinge는 "보호가 정답인 레짐"
  (170: 조임=최적과 정렬)에선 무해, "흡수가 정답인 레짐"(155+사고: 용량 충분)에서
  조임 유발로 유해. 통제가능/불가 혼잡 페널티 비대칭의 정밀판.
- **사용자 결정(2026-07-13): hinge ON 유지 확정.** headline = NP-CAND+hinge 열
  (155 7036 / 155_skew 7509 / 155_inc 8124★ / 170 11324 / 170_skew 11494 /
  170_inc 11497 / 190 15654). ★155_inc는 nbr(7256)에 역전 — 정직 보고 + 비대칭
  기제 각주. 3600s 청산형 스위트가 주 실험(사용자 확인), 지속 매트릭스는 보조
  (전이곡선·whipsaw·반경 담당). pulse_low(85%) 셀 신설·측정 중.
