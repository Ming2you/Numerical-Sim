...
- 권고: hinge 기본 OFF(사고 실이 평상 득 압도 + 서사 치명 + v3 면제범위 자의적),
  코드·v2는 opt-in 보존(통제가능/불가 혼잡 페널티 비대칭 = 각주감).
  **복원 지시와 상충 — 사용자 결정 대기.** OFF 시 headline = NP-CAND 열
  (170_skew·170_inc 빈칸 채우기 런 진행 중).
