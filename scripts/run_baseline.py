"""Run a baseline-only closed-loop simulation."""
...
def main() -> None:
    ...
    result = run_closed_loop(cfg, scenario, "baseline", args.output, baseline_mode=args.baseline)
    print(f"baseline total_ttt={result['total_ttt']:.6f} output={args.output}")
