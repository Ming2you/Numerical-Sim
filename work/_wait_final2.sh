...
while :; do
  ...
  for c in 155 170 170skew 170inc 190; do
    f="outputs/_diag/fin2_${c}/$PS/run_log.csv"
...
wins=0; done=0
for cell,nm,src in [('155','Low','fin2_155'),('170','Med','fin2_170'),('170skew','Skew','fin2_170skew'),
                    ('170inc','Inc','fin2_170inc'),('190','High','fin2_190')]:
