...
def build_cfg(scenario_name: str = "sweet_128", t_total: float = 720.0) -> ExperimentConfig:
    overrides = {
        "mpc": dict(OVERRIDES["mpc"]),
...
def main():
    ...
    t_total = float(sys.argv[2]) if len(sys.argv) > 2 else 720.0
