...
| 최대 | 34.5 | 5.0 | 3.5 | 96.6 | 132.4(20런 병렬 부하 조건) | 팔 간 병렬 부하가 달라(6~20런) 배치 수치는 상한으로만 읽어야 하며, 단독 동일 조건 재측정(190_w)에서는 P-CENT 40.4 s/step vs P-Stack 45.7 s/step로 근사 동급이다 — 두 값 모두 제어주기 180 s를 큰 여유로 하회한다.
