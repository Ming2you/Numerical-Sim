...
PROPOSED_GROUP = {"PROPOSED-FOLLOWERS-ONLY", "PROPOSED-STACKELBERG", "PROPOSED-CENTRALIZED", "PROPOSED-STACKELBERG-WU"}
LEADER_ENABLED = {"WU-MATCHED-STACKELBERG", "PROPOSED-STACKELBERG", "PROPOSED-STACKELBERG-WU"}
